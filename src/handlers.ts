...
export async function priceHandler(ctx: MyContext): Promise<void> {
  ...
  try {
    ...
    await ctx.reply("Unable to start price check. Please try again.", {
      reply_markup: mainMenuKeyboard(),
    });
  }
  ctx.session.step = undefined;
...
export async function summaryHandler(ctx: MyContext): Promise<void> {
  ...
  try {
    ...
    await ctx.reply("Unable to load your settings. Please try again.", {
      reply_markup: mainMenuKeyboard(),
    });
  }
}
...
export async function quietHandler(ctx: MyContext): Promise<void> {
  ...
  try {
    ...
    await ctx.reply("Unable to load your quiet hours settings. Please try again.", {
      reply_markup: mainMenuKeyboard(),
    });
  }
}
...
export async function callbackQueryHandler(ctx: MyContext): Promise<void> {
  try {
    ...
    try {
      await ctx.reply("An error occurred. Please use /start to return to the main menu.", {
        reply_markup: mainMenuKeyboard(),
      });
    } catch {
